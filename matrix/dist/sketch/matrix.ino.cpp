...
#line 27 "c:\\GIT\\ESP32-Projects\\matrix\\matrix.ino"
uint16_t colorWheel(uint8_t pos);
#line 39 "c:\\GIT\\ESP32-Projects\\matrix\\matrix.ino"
void drawText(int colorWheelOffset);
#line 95 "c:\\GIT\\ESP32-Projects\\matrix\\matrix.ino"
void setup();
#line 144 "c:\\GIT\\ESP32-Projects\\matrix\\matrix.ino"
void loop();
#line 27 "c:\\GIT\\ESP32-Projects\\matrix\\matrix.ino"
uint16_t colorWheel(uint8_t pos) {
  if(pos < 85) {
...
void drawText(int colorWheelOffset)
{
  ...
  dma_display->println("RUDI IST");
	dma_display->println("SCHÖN");
